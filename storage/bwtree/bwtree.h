...
// Note: No longer maintained, should avoid using this
...
#define INC_COUNTER(name, value)                                       \
  do                                                                   \
  {                                                                    \
    GetCurrentGCMetaData()->counters[GCMetaData::CounterType::name] += \
        value;                                                         \
  } while (false);
#else
#define INC_COUNTER(name, value) \
...
#define LeafInlineAllocateOfType(T, node_p, ...) (new T{__VA_ARGS__})
    ...
    public:
      ...
      public:
         ...
         * Constructor
         */
        GarbageNode(uint64_t p_delete_epoch, void *p_node_p) : delete_epoch{p_delete_epoch},
                                                               node_p{p_node_p},
                                                               next_p{nullptr}
        {
        }

        GarbageNode() : delete_epoch{0UL},
                        node_p{nullptr},
                        next_p{nullptr}
        {
        }
      ...
      public:
         ...
         * Default constructor
         */
        GCMetaData() : last_active_epoch{0UL},
                       header{},
                       last_p{&header},
                       node_count{0UL}
        {
    ...
    public:
       ...
       */
      BwTreeBase() : gc_metadata_p{nullptr},
                     original_p{nullptr},
      ...
      inline GCMetaData *GetGCMetaData(int thread_id)
      {
        ...
        assert(thread_id >= 0);
        assert(thread_id < static_cast<int>(thread_num));
    ...
    public:
      ...
      public:
         ...
         */
        KeyValuePairEqualityChecker(BwTree *p_tree_p) : key_eq_obj_p{&p_tree_p->key_eq_obj},
      ...
      public:
         ...
         * Constructor - Initialize a key value pair hash function
         */
        KeyValuePairHashFunc(BwTree *p_tree_p) : key_hash_obj_p{&p_tree_p->key_hash_obj},
      ...
      public:
        ...
        NodeMetaData(const KeyNodeIDPair *p_low_key_p,
                     ...
                     NodeType p_type,
                     int p_depth,
                     int p_item_count) : low_key_p{p_low_key_p},
      ...
      public:
        ...
        BaseNode(NodeType p_type,
                 ...
                 const KeyNodeIDPair *p_high_key_p,
                 int p_depth,
                 int p_item_count) : metadata{p_low_key_p,
                                              p_high_key_p,
                                              p_type,
                                              p_depth,
                                              p_item_count}
      ...
      public:
        ...
        DeltaNode(NodeType p_type,
                  ...
                  const KeyNodeIDPair *p_high_key_p,
                  int p_depth,
                  int p_item_count) : BaseNode{p_type,
                                               p_low_key_p,
                                               p_high_key_p,
                                               p_depth,
                                               p_item_count},
      ...
      public:
        ...
        LeafDataNode(const KeyValuePair &p_item,
                     ...
                     const KeyNodeIDPair *p_high_key_p,
                     int p_depth,
                     int p_item_count) : DeltaNode{p_type,
                                                   p_child_node_p,
                                                   p_low_key_p,
                                                   p_high_key_p,
                                                   p_depth,
      ...
      public:
        ...
        LeafInsertNode(const KeyType &p_insert_key,
                       ...
                       const BaseNode *p_child_node_p,
                       std::pair<int, bool> p_index_pair) : LeafDataNode{std::make_pair(p_insert_key, p_value),
      ...
      public:
        ...
        LeafDeleteNode(const KeyType &p_delete_key,
                       const ValueType &p_value,
                       const BaseNode *p_child_node_p,
                       std::pair<int, bool> p_index_pair) : LeafDataNode{std::make_pair(p_delete_key, p_value),
      ...
      public:
        ...
        LeafUpdateNode(const KeyType &p_update_key,
                       ...
                       const BaseNode *p_child_node_p,
                       std::pair<int, bool> p_index_pair) : LeafDataNode{std::make_pair(p_update_key, p_new_value),
      ...
      public:
        ...
        LeafSplitNode(const KeyNodeIDPair &p_insert_item,
                      const BaseNode *p_child_node_p,
                      const BaseNode *p_split_node_p) : DeltaNode{NodeType::LeafSplitType,
                                                                  p_child_node_p,
                                                                  &p_child_node_p->GetLowKeyPair(),
      ...
      public:
        ...
        LeafRemoveNode(NodeID p_removed_id,
                       const BaseNode *p_child_node_p) : DeltaNode{NodeType::LeafRemoveType,
                                                                   p_child_node_p,
                                                                   &p_child_node_p->GetLowKeyPair(),
                                                                   &p_child_node_p->GetHighKeyPair(),
      ...
      public:
        ...
        LeafMergeNode(const KeyType &p_merge_key,
                      ...
                      const BaseNode *p_child_node_p) : DeltaNode{NodeType::LeafMergeType,
                                                                  p_child_node_p,
                                                                  &p_child_node_p->GetLowKeyPair(),
      ...
      public:
        ...
        InnerInsertNode(const KeyNodeIDPair &p_insert_item,
                        ...
                        const BaseNode *p_child_node_p,
                        int p_location) : InnerDataNode{p_insert_item,
      ...
      public:
        ...
        InnerDeleteNode(const KeyNodeIDPair &p_delete_item,
                        ...
                        const KeyNodeIDPair &p_next_item,
                        const BaseNode *p_child_node_p,
                        int p_location) : InnerDataNode{p_delete_item,
      ...
      public:
        ...
        InnerSplitNode(const KeyNodeIDPair &p_insert_item,
                       const BaseNode *p_child_node_p,
                       const BaseNode *p_split_node_p) : DeltaNode{NodeType::InnerSplitType,
                                                                   p_child_node_p,
      ...
      public:
        ...
        InnerRemoveNode(NodeID p_removed_id,
                        const BaseNode *p_child_node_p) : DeltaNode{NodeType::InnerRemoveType,
                                                                    p_child_node_p,
                                                                    &p_child_node_p->GetLowKeyPair(),
                                                                    &p_child_node_p->GetHighKeyPair(),
                                                                    p_child_node_p->GetDepth(),
      ...
      public:
        ...
        InnerMergeNode(const KeyType &p_merge_key,
                       const BaseNode *p_right_merge_p,
                       NodeID p_deleted_node_id,
                       const BaseNode *p_child_node_p) : DeltaNode{NodeType::InnerMergeType,
                                                                   p_child_node_p,
                                                                   &p_child_node_p->GetLowKeyPair(),
                                                                   &p_right_merge_p->GetHighKeyPair(),
      ...
      public:
         ...
         * Constructor
         */
        InnerAbortNode(const BaseNode *p_child_node_p) : DeltaNode{NodeType::InnerAbortType,
                                                                   p_child_node_p,
                                                                   &p_child_node_p->GetLowKeyPair(),
                                                                   &p_child_node_p->GetHighKeyPair(),
                                                                   p_child_node_p->GetDepth(),
      ...
      public:
         ...
         */
        NodeSnapshot(NodeID p_node_id, const BaseNode *p_node_p) : node_id{p_node_id},
                                                                   node_p{p_node_p}
        {
        }
      ...
      public:
         ...
         * Constructor
         */
        AllocationMeta(char *p_tail, char *p_limit) : tail{p_tail},
                                                      limit{p_limit},
                                                      next{nullptr}
        {
        }
      ...
      public:
        ...
        ElasticNode(NodeType p_type,
                    ...
                    const KeyNodeIDPair &p_high_key) : BaseNode{p_type, &low_key, &high_key, p_depth, p_item_count},
                                                       low_key{p_low_key},
                                                       high_key{p_high_key},
                                                       end{start},
                                                       extra_data{}
    ...
    public:
      ...
      public:
        ...
        LeafNode(int p_depth,
                 int p_item_count,
                 const KeyNodeIDPair &p_low_key,
                 const KeyNodeIDPair &p_high_key) : LeafBaseType{NodeType::LeafType,
                                                                 p_depth,
                                                                 p_item_count,
                                                                 p_low_key,
                                                                 p_high_key}
    ...
    public:
      ...
      BwTree(bool start_gc_thread = true,
             ...
             ValueHashFunc p_value_hash_obj = ValueHashFunc{}) : BwTreeBase(),
      ...
      NodeID NavigateInnerNode(Context *context_p)
      {
        ...
        int end_index =
            static_cast<InnerNode *>(
                InnerNode::GetNodeHeader(&node_p->GetLowKeyPair()))
                ->GetSize();
...
// freed has been called inside epoch manager
      ...
      private:
         ...
         */
        IteratorContext(BwTree *p_tree_p) : tree_p{p_tree_p},
                                            ref_count{0UL}
        {
        }
      ...
      public:
         ...
         */
        ForwardIterator(BwTree *p_tree_p,
                        const KeyType &start_key) : ic_p{nullptr},
                                                    kv_p{nullptr}
        {
         ...
         */
        ForwardIterator(const ForwardIterator &other) : ic_p{other.ic_p},
                                                        kv_p{other.kv_p}
        {
