...
namespace ART_OLC {
    ...
    bool Tree::lookupRange(const Key &start, const Key &end, Key &continueKey, TID result[],
                                std::size_t resultSize, std::size_t &resultsFound, ART::ThreadInfo &threadEpocheInfo) const {
    ...
    void Tree::insert(const Key &k, TID tid, ART::ThreadInfo &epocheInfo) {
    ...
    void Tree::remove(const Key &k, ART::ThreadInfo &threadInfo) {
