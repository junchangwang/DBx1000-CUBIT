...
def cdf():
    cmd = "./build/nicolas -w 16 -a naive -m mix --number-of-queries 950 -r 50 -c 100 -i 100M_100/ -n 100000000 -v yes --fence-pointer no > figure_naive_latency_raw_w_16_ratio_0.05.dat"
    cmd2 = "./build/nicolas -w 16 -a nbub -m mix --number-of-queries 950 -r 50 -c 100 -i 100M_100/ -n 100000000 -v yes --fence-pointer yes --fence-length 100000 > figure_nbub_latency_raw_w_16_ratio_0.05.dat"
    cmd3 = "./build/nicolas -w 16 -a nbub-lf -m mix --number-of-queries 950 -r 50 -c 100 -i 100M_100/ -n 100000000 -v yes --fence-pointer yes --fence-length 100000 > figure_nbub-lf_latency_raw_w_16_ratio_0.05.dat"
    cmd4 = "./build/nicolas -w 16 -a ub -m mix --number-of-queries 950 -r 50 -c 100 -i 100M_100/ -n 100000000 -v yes --fence-pointer yes --fence-length 100000 > figure_ub_latency_raw_w_16_ratio_0.05.dat"
    cmd5 = "./build/nicolas -w 16 -a ucb -m mix --number-of-queries 950 -r 50 -c 100 -i 100M_100/ -n 100000000 -v yes --fence-pointer yes --fence-length 100000 > figure_ucb_latency_raw_w_16_ratio_0.05.dat"
    os.system(cmd)
    os.system(cmd2)
    os.system(cmd3)
    os.system(cmd4)
