...
reset
set key invert top left #horizontal
...
plot  "../dat/figure_1_ucb.dat" using ($1/1000):($2/1e3) every 200 title "State-of-the-art Update-Optimized Bitmap Index" lc rgb "black" ps 2 pt 6 with linespoints
