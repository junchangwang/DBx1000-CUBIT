...
set y2label "Space Overhead (ratio)" offset 0.5,0,0
set logscale y2
set y2tics nomirror
set ytics nomirror
...
set y2label "Space Overhead (ratio)" offset 1,0,0
set logscale y2
set y2tics
...
plot '../dat/fp_ucb.dat' every 2    using ($1/1e3):xtic(2) t "UpBit-FP" with boxes fs solid 1.0 border rgb "black" lc rgb "grey", \
     '../dat/fp_ucb.dat' every 2::1 using ($1/598366184):xtic(2) t "Space overhead" axes x1y2 lc "black" ps 2 with linespoints
...
plot '../dat/fp_ub.dat' every 2    using ($1/1e3):xtic(2) t "UpBit" with boxes fs solid 1.0 border rgb "black" lc rgb "grey", \
     '../dat/fp_ub.dat' every 2::1 using ($1/598366184):xtic(2) t "Space overhead" axes x1y2 lc "black" ps 2 with linespoints
